...
//alert(localStorage.getItem("access_token"));
  ...
  //  }
    $rootScope.$on("$locationChangeStart", function (event, next, current) {
     ...
     if (localStorage.getItem("tenant_id") == null && $rootScope.currentPath != '/registration'  && $rootScope.currentPath != '/wifi' && $rootScope.currentPath != '/machinenew' && $rootScope.currentPath != '/oee' && $rootScope.currentPath != '/shiftpart' && $rootScope.currentPath != '/cyclestop' && $rootScope.currentPath != '/hmi' && $rootScope.currentPath != '/dashboardnew' && $rootScope.currentPath != '/faq_question' && $rootScope.currentPath != '/alldetails' && $rootScope.currentPath != '/companydetails' && $rootScope.currentPath != '/frontpage' && $rootScope.currentPath != '/chart' && $rootScope.currentPath != '/lmw' && $rootScope.currentPath != '/adminuser' && $rootScope.currentPath != '/device' && $rootScope.currentPath != '/setting'  && $rootScope.currentPath != '/tenant' && $rootScope.currentPath != '/device_registration' && $rootScope.currentPath != '/changepassword' && $rootScope.currentPath != '/statuschart') {
        $location.path('/login')
        return;
      }
   ...
   if ($rootScope.currentPath == '/alternative' || $rootScope.currentPath== '/view2'  || $rootScope.currentPath == '/download' || $rootScope.currentPath== '/reason' ) {
  ...
  .controller('appctrl', ['$scope', '$http', '$location', '$rootScope', '$window', '$templateCache','$translate',
    function ($scope, $http, $location, $rootScope, $window, $templateCache,$translate) {
     ...
     $rootScope.fileShow = false;
      ...
      $scope.currentPath = $location.path();
        ...
        $rootScope.api_url = "http://yantra.local:4001/";
         $rootScope.api_url_report = "http://yantra.local:4001/";
    ...
    //  $rootScope.api_url_report = "http://52.66.140.40/";
        ...
        //$rootScope.api_url_report = "https://app.yantra24x7.com/";
